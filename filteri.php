...
<!--===============================================================================================-->
    ...
    <div class="wrap-contact100">
      <form class="contact100-form validate-form" action="filterbyplant.php" method="post">
        ...
        <div class="wrap-input100 validate-input" data-validate="ID is required">
          ...
          <input class="input100" type="text" name="item" placeholder="Enter plant ID">
